...
const paintings = [
  ...
  { bg:'#D85A30', a1:'#F0997B', a2:'#712B13', img:'images/passage.jpeg',
    ...
    lt:{name:'Passage',  med:'Aliejus ant drobės'},
  ...
  { bg:'#7F77DD', a1:'#D85A30', a2:'#FAC775', img:'images/sex.jpeg',
    ...
    en:{name:'Evening in Alentejo',  med:'Oil on canvas'},
    dim:'80 × 100 cm', year:'2024', price:'€ 1 200' },
  { bg:'#D85A30', a1:'#F0997B', a2:'#712B13', img:'images/woman.jpeg',
    medium:'oil', series:'figures',    size:'medium', avail:true,
    lt:{name:'Figūra, ryto šviesa',  med:'Aliejus ant drobės'},
    en:{name:'Figure, morning light', med:'Oil on canvas'},
    dim:'60 × 80 cm', year:'2023', price:'€ 890' },
  { bg:'#1D9E75', a1:'#085041', a2:'#5DCAA5', img:'images/bro.jpeg',
    medium:'acrylic', series:'still-life', size:'small', avail:true,
    lt:{name:'Natiurmortas III',     med:'Akrilas ant drobės'},
    en:{name:'Still life III',       med:'Acrylic on canvas'},
    dim:'50 × 50 cm', year:'2023', price:'€ 650' },
  { bg:'#FAC775', a1:'#EF9F27', a2:'#BA7517', img:'images/hannibal.jpeg',
    medium:'oil', series:'studies',    size:'small', avail:false,
    lt:{name:'Šiltas etiudas Nr. 7', med:'Aliejus ant popieriaus'},
    en:{name:'Warm study No. 7',     med:'Oil on paper'},
    dim:'40 × 40 cm', year:'2022', price:'€ 480' },
  { bg:'#534AB7', a1:'#3C3489', a2:'#7F77DD', img:'images/water.jpeg',
    medium:'oil', series:'landscapes', size:'large', avail:true,
    lt:{name:'Mėlynoji valanda',     med:'Aliejus ant drobės'},
    en:{name:'Blue hour',            med:'Oil on canvas'},
    dim:'70 × 90 cm', year:'2024', price:'€ 750' },
  { bg:'#F0997B', a1:'#D85A30', a2:'#FAC775', img:'images/heylady.jpeg',
    medium:'watercolour', series:'studies', size:'small', avail:true,
    lt:{name:'Vasaros etiudas',          med:'Akvarelė ant popieriaus'},
    en:{name:'Summer study',             med:'Watercolour on paper'},
    dim:'30 × 30 cm', year:'2022', price:'€ 320' },
  { bg:'#7F77DD', a1:'#D85A30', a2:'#FAC775', img:'images/mazius.jpeg',
    medium:'oil', series:'landscapes', size:'large', avail:true,
    lt:{name:'Mažasis',              med:'Aliejus ant drobės'},
    en:{name:'The Little One',       med:'Oil on canvas'},
    dim:'80 × 100 cm', year:'2024', price:'€ 1 200' },
  { bg:'#7F77DD', a1:'#D85A30', a2:'#FAC775', img:'images/kiaule.jpeg',
    medium:'oil', series:'figures',    size:'large', avail:true,
    lt:{name:'Kiaulė',               med:'Aliejus ant drobės'},
    en:{name:'The Pig',              med:'Oil on canvas'},
    dim:'80 × 100 cm', year:'2024', price:'€ 1 200' },
];
...
const strings = {
  ...
  en: {
    ...
    groups:[
      ...
      {key:'year',    label:'year',         opts:[{k:'2024',l:'2024'},{k:'2023',l:'2023'},{k:'2022',l:'2022'}]},
    ],
